export const text: any = {
  EN: [
    'Promise is an application that offers the most efficient way to read.',
    'To quickly read any book, you need to follow two simple steps.',
    ...
    "You don't have to choose a book in advance. You can read many books at the same time. You need to choose the number of hours that you will devote to reading and the deadline. Open a book, start flipping pages and the timer will start counting down. By the end of the term, you must reset the timer. ",
    'While reading, you should not worry about the safety of your money.',
    'When placing a bet, you transfer money to a smart contract. A smart contract is a smart crypto wallet that no one owns. He himself decides to whom to give money and to whom not. It is this wallet that is watching your reading. Turning pages, you send him notifications about what you are reading and continue to read, and he keeps track of time. As soon as you fulfill his conditions, he will return your money back.',
    'Lucky reading.',
  ...
  RU: [
    'Promise - это приложение, которое предлагает наиболее эффективный способ чтения. ',
    'Чтобы быстро прочитать любую книгу, Вам нужно выполнить два простых действия.',
    'Выберите книгу и сделайте ставку, что успеете прочитать ее в срок.',
    'Если не успеете, Ваша ставка сгорит. Если успеете, вернете свои деньги. Никакой прибыли, кроме прочитанной книги',
    'Заранее книгу выбирать не обязательно. Можно читать много книг одновременно. Выбрать нужно количество часов, которые вы посвятите чтению и крайний срок.',
    'Откройте книгу, начните листать страницы и таймер начнет обратный отсчет. К концу срока вы должны обнулить таймер.',
    'Во время чтения, Вас не должна беспокоить мысль о сохранности Ваших денег.',
    'Делая ставку, Вы переводите деньги на смарт-контракт. Смарт-контракт это умный крипто-кошелек, которым никто не владеет. Он сам решает кому давать деньги, а кому нет. Именно этот кошелек наблюдает за вашим чтением. Листая страницы вы шлете ему уведомления, о том что читаете и продолжаете читать, а он ведет счет времени. Как только вы выполните его условия, он вернет Ваши деньги обратно.',
    'Удачного чтения',
